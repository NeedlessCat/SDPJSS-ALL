...
const AccountStatusModal = () => {
  const { userData, familyData, setToken, setUToken } = useContext(AppContext);
  ...
  const shouldShowModal =
    currentUser &&
    (currentUser.isApproved === "pending" ||
      currentUser.isApproved === "disabled");
  ...
  const getMessage = () => {
    if (currentUser?.isApproved === "pending") {
      return "Your account is currently under review. Please wait for approval or contact support for assistance.";
    } else if (currentUser?.isApproved === "disabled") {
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex items-center justify-center gap-2">
                ...
                <span>Helpline: +91-XXXX-XXXXXX</span>
              </div>
              <div className="flex items-center justify-center gap-2">
                <svg
                  className="h-4 w-4"
